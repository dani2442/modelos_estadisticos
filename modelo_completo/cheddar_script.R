...
resettest(m2inf, power=2:3, type="regressor", data=cheddar[train.2inf,]) # empeora poco

# Decicimos no redefinirlo pues todas las hipotesis empeoran
...
t.test(resid(model.final), mu = 0, alternative = "two.sided") # media cero de los residuos
