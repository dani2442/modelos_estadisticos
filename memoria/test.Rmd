...
df_pval_drop_p1 <- data.frame("1" = rep(0,4),"2" = rep(0,4),"3" = rep(0,4),
                              row.names =c("train1: L","train1: H2S + L",
                                  "train2: H2S + L",
                                  "train3: H2S + L"))

fila_c1 <- c("1,5,16,23,24,26", "1,12,24","1,3,5,8,9,12,13,14,16,19,23,24,27,28,30")
fila_c2 <- c("23", "12", "COMPLETAR")
fila_c3 <- c("6","COMPLETAR" , "COMPLETAR")
fila_c4 <- c("COMPLETAR","COMPLETAR","COMPLETAR")
colnames(df_pval_drop_p1) <- c("Criterio 1","Criterio 2","Criterio 3")
