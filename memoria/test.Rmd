...
colnames(df_pval_drop_p1) <-    c("train1: L","train1: L, sin influyentes", "Test utilizadp")
...
df_pval_drop_p1
```
**ESCRIBIR QUE ES MEJOR Y ACTUALIZAR DATOS**
```{r include=FALSE}
train.1<-train.1inf
model.1<-model.1inf
```
...
```{r}
# PONER TABLA COMPARATIVA CON TEST DE LAS HIPOTESIS
```
